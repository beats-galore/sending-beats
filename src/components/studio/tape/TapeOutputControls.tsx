 ...
 * is what separates the patchbay's tape node from the TAPE view.
 */
export const TapeOutputControls = ({ density, tape }: TapeOutputControlsProps) => {
  ...
  return (
    <>
      ...
      <div>
        ...
        />
        <Text size="2xs" c={color.textFaintest} mt={density === 'compact' ? '2xs' : 'xs'}>
