...
import { MixerConfig, AudioDeviceInfo } from '../../types';
...
export const MasterSection = memo<MasterSectionProps>(({
  ...
  const { setMasterGain } = useMixerState();
  const { masterLevels, metrics } = useVUMeterData();
  ...
  return (
    <Paper p="lg" withBorder radius="md">
      <Stack gap="lg">
        <Title order={3} c="blue">Master Section</Title>
          ...
          <Grid.Col span={4}>
            <Stack align="center">
              ...
              <Group justify="center" gap="lg">
                <Center>
                  <Stack align="center">
                    <Text size="sm" c="dimmed">L</Text>
                    <VUMeter
                      peakLevel={masterLevels.left.peak_level}
                      rmsLevel={masterLevels.left.rms_level}
                      height={200}
                      width={20}
                    />
                    <Text size="xs" c="dimmed">
                      {masterLevels.left.peak_level.toFixed(3)}
                    </Text>
                  </Stack>
                </Center>
                ...
                <Center>
                  <Stack align="center">
                    ...
                    <VUMeter
                      peakLevel={masterLevels.right.peak_level}
                      rmsLevel={masterLevels.right.rms_level}
                      height={200}
                      width={20}
                    />
                    <Text size="xs" c="dimmed">
                      {masterLevels.right.peak_level.toFixed(3)}
                    </Text>
                  </Stack>
                </Center>
              </Group>
            ...
            <Stack gap="lg">
              ...
              <Stack gap="xs">
                <Group justify="space-between">
                  <Text size="sm" c="dimmed">Master Output Device</Text>
                  <ActionIcon 
                    variant="light" 
            ...
            <Stack gap="sm">
              ...
              {metrics ? (
                <Stack gap="xs">
                  ...
                  <Group justify="space-between">
                    <Text size="sm" c="dimmed">Active Channels:</Text>
                    <Text size="sm">{metrics.active_channels}</Text>
                  </Group>
                  <Group justify="space-between">
                    <Text size="sm" c="dimmed">Buffer Underruns:</Text>
                    <Text size="sm" c={metrics.buffer_underruns > 0 ? "red" : "green"}>
                      {metrics.buffer_underruns}
                    </Text>
                  </Group>
                  <Group justify="space-between">
                    <Text size="sm" c="dimmed">Buffer Overruns:</Text>
