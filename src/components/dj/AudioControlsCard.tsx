...
import { IconDevices, IconRefresh, IconPlayerPlay, IconPlayerPause } from '@tabler/icons-react';
        ...
        <Stack gap="md">
          ...
          {selectedDevice === 'system-audio' && (
            <Alert color="yellow" variant="light">
              Note: System audio capture may require additional permissions and may not work in all
              browsers.
            </Alert>
          )}
