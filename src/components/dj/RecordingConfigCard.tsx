import { Card, Stack, Group, Title, TextInput, Select, Switch, NumberInput, Textarea, Button, Badge, Text, Modal, ScrollArea } from '@mantine/core';
...
export const RecordingConfigCard = memo<RecordingConfigCardProps>(
  ({ disabled = false }) => {
    ...
    const updateEditingConfig = useCallback((updates: Partial<RecordingConfig>) => {
      if (editingConfig) {
            ...
            {selectedConfig && (
              <Stack gap="sm">
                ...
                {selectedConfig.metadata.artist && (
                  <Group>
                    <Text size="xs" c="dimmed">Artist:</Text>
            ...
            <Stack gap="md" className={classes.modalContent}>
              ...
              <Stack gap="sm">
                ...
                <Select
                  ...
                  onChange={(value) => value && updateEditingConfig({ format: parseFormatValue(value) })}
                  data={formatOptions}
                />
              ...
              <Stack gap="sm">
                ...
                <Switch
                  ...
                  onChange={(e) => updateEditingConfig({ auto_stop_on_silence: e.currentTarget.checked })}
                />
                ...
                {editingConfig.auto_stop_on_silence && (
                  <Group grow>
                    <NumberInput
                      ...
                      onChange={(value) => typeof value === 'number' && updateEditingConfig({ silence_threshold_db: value })}
                      min={-100}
                      max={0}
                      step={5}
                    />
                    <NumberInput
                      ...
                      onChange={(value) => typeof value === 'number' && updateEditingConfig({ silence_duration_sec: value })}
                      min={1}
                      max={60}
                    />
                  </Group>
                ...
                <Group grow>
                  <NumberInput
                    ...
                    onChange={(value) => updateEditingConfig({ 
                      max_duration_minutes: (typeof value === 'number' && value > 0) ? value : undefined 
                    })}
                    min={0}
                    max={1440}
                  />
                ...
                <Group grow>
                  <NumberInput
                    ...
                    onChange={(value) => typeof value === 'number' && updateEditingConfig({ sample_rate: value })}
                    min={8000}
                    max={192000}
                    step={1000}
                  />
                  <NumberInput
                    ...
                    onChange={(value) => typeof value === 'number' && updateEditingConfig({ channels: value })}
                    min={1}
                    max={8}
                  />
                </Group>
