...
export const RecordingControlsCard = memo<RecordingControlsCardProps>(
  ({ disabled = false }) => {
          ...
          {isRecording && currentSession && (
            <Stack gap="xs">
              ...
              <Group justify="space-between">
                ...
                <Text size="xs" c="dimmed">
                  Levels: L:{(currentSession.current_levels[0] * 100).toFixed(0)}% R:{(currentSession.current_levels[1] * 100).toFixed(0)}%
                </Text>
              </Group>
            </Stack>
          )}
                ...
                {showAdvanced && (
                  <Stack gap="sm">
                    <Switch
                      ...
                      onChange={(event) => setQuickConfig(prev => ({
                        ...prev,
                    ...
                    <Group grow>
                      <NumberInput
                        ...
                        onChange={(value) => setQuickConfig(prev => ({
                          ...prev,
