import { Stack, Card, Group, Title, Badge, Grid, Button } from '@mantine/core';
...
export const DashboardTab = memo<DashboardTabProps>(
  ({ isLive, currentDJ, analytics, onGoLive, onTabChange }) => {
        ...
        <Card className={classes.tableCard} padding="lg" withBorder>
          <Group justify="space-between" align="center" mb="lg">
            ...
            <Group className={classes.statusIndicator}>
              ...
              <Badge color={isLive ? 'green' : 'red'} variant="light" size="md">
